...
import type { TrilhaAuditoria } from '../domain/ports';

/**
 * Liga o port do domínio à trilha de verdade. Grava na transação do request, então o registro
 * cai junto com a operação se algo falhar — trilha que sobrevive a um rollback é trilha mentindo.
 */
@Injectable()
